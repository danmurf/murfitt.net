...
pubDatetime: 2023-12-21T10:01:16Z
tags:
  - LLMs
  - AI
  - Prompt Engineering
description: "I've recently been experimenting with the idea of creating a generative AI prompt which can build other prompts for specific personas. Sometimes I know rou…"
heroImage: /images/posts/building-a-prompt-to-generate-chatbot-persona-prompts/robots-creating-robots.jpeg
heroAlt: "A generated image of an impressionist style painting (oil on canvas) of a robot creating another robot."
heroCaption: "Image generated using Stable Diffusion. An impressionist painting of the future, where robots create other robots. Oil on canvas."
---
...
![1: start with a simple idea, 2: expand upon idea and build persona, 3: condense persona into prompt](/images/posts/building-a-prompt-to-generate-chatbot-persona-prompts/3-step-approach.png)
...
<h3>Comments</h3>
<p>If you found this helpful, or have any questions, please feel free to <a href="https://twitter.com/danmurf/status/1738531905744609433" target="_blank" rel="noopener">drop me a reply on X (formerly Twitter)</a>. ❤️</p>
